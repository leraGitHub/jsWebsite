...
function check(a) {
    if (newArray[a-1]==j) {
        j++; 
       document.getElementsByClassName("number")[0].style.background = "lightgreen";
       document.getElementsByClassName("number")[0].innerHTML=j;
       if (j==26) {
        for (var k=0; k<26; k++) {
        ...
        document.getElementsByClassName("number")[0].style.background = "pink";
        document.getElementsByClassName("number")[0].innerHTML=j;
