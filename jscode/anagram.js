...
var randWord=null;
   ...
   function start() {
    var answer = document.getElementById('btn');
        ...
        answer.style.outlineColor='silver';
        answer.style.color='black';
        answer.value = '';

        var randNumber = getRandomInt(array.length, 0); 

        randWord = array[randNumber]; 

        var arrWord = randWord.split(''); 
        ...
        var shuffledArr = shuffle(arrWord);
        console.log(shuffledArr);

        var shuffledWord = shuffledArr.join(''); 
        console.log(shuffledWord);

        document.getElementsByClassName("word")[0].innerHTML=shuffledWord; 
    ...
    function check() {
        ...
        if (answer.value.toLowerCase()==randWord) {
            answer.style.outlineColor='green';
            answer.style.color='green';
            setTimeout(start, 1000);
        } else {
            answer.style.outlineColor='red';      
